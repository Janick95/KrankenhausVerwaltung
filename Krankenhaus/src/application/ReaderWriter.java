...
public class ReaderWriter {
	...
	// Die Methode erwartet den Dateipfad eines Textdokumentes und gibt den Inhalt
	// der entsprechenden Textdatei als Array zurück
	public static String[] readToArray(String file) throws IOException {
		...
		// Erstellt einen neuen Reader, damit der Schreibkopf wieder am Anfang des
		// Dokumentes steht. Ansonsten würde nur null ausgelesen werden
	...
	// Die Methode erwartet den zu schreibenden Text als String, sowie den Dateipfad
	// des Textdokumentes, in das geschrieben werden soll
	...
	// Sucht nach dem gewünschten Eintrag und löscht die gesamte Zeile, in der der
	// Eintrag vorkommt; Funktioniert nur mit einem Eintrag und dem löschen einer
	// Zeile
